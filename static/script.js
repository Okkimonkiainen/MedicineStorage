...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    */
        let urlhaku='https://laaketilat.eu.pythonanywhere.com/popup?haetaan=1'
        fetch(urlhaku)
        .then(data=>{
            return data.json();
        })
        .then(tiedot=>{
           if(tiedot.tulos!=undefined && tiedot.olosuhde!=undefined && tiedot.paikka!=undefined){
               ...
               for(let i=0; i<halytysdiv.length; i++){
                    ...
                    a.setAttribute('href', 'https://laaketilat.eu.pythonanywhere.com/kuittaus?mittaus='+tiedot.mittauksen_id+'&alue='+painonappi.id);
